...
router.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        ...
        newUser.save();
        const token = jsonwebtoken_1.default.sign({ email, role: 'user' }, auth_1.SECRET, { expiresIn: '1h' });
...
router.get('/me', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/courses', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const courses = yield db_1.Course.find({ published: true });
    res.json({ courses: courses });
}));
router.get('/courses/:courseId', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//purchaseCourse
router.post('/courses/:courseId', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const email = req.headers["email"];
    try {
        ...
        console.error(error);
        res.status(500).json({ message: 'Internal server error while purchasing course' });
    }
}));
router.get('/purchasedCourses', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const email = req.headers["email"];
...
router.post('/orders', auth_1.authenticateUserJwt, (req, res) => {
...
router.post('/verify', auth_1.authenticateUserJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const email = req.headers["email"];
    ...
    if (isAuthentic) {
        const payment = new db_1.Payment({ razorpay_order_id, razorpay_payment_id, razorpay_signature, email: email });
        payment.save();
        res.status(200).json({
            message: "SIGN VALID",

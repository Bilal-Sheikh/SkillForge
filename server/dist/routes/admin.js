...
router.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (admin) {
        ...
        newAdmin.save();
        const token = jsonwebtoken_1.default.sign({ email, role: 'admin' }, auth_1.SECRET, { expiresIn: '1h' });
...
// create course
router.post('/courses', auth_1.authenticateAdminJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.put('/courses/:courseId', auth_1.authenticateAdminJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/courses/:courseId', auth_1.authenticateAdminJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete('/courses/:courseId', auth_1.authenticateAdminJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const email = req.headers["email"];
